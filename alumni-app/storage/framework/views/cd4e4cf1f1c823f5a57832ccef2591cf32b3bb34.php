...
<div class="registration-container">
    ...
    <form action="<?php echo e(url('/alumniss')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\N RATHNA PRABA\alumni-app\resources\views/alumni/register.blade.php ENDPATH**/ ?>