...
for doc in documents:
    ...
    # Append bag and output_row separately to training
    training.append([bag, output_row])

# Convert each component to a numpy array separately
...
train_x = np.reshape(bags, (bags.shape[0], len(words)))
train_y = np.reshape(output_rows, (output_rows.shape[0], len(classes)))
